...
public class Transformer1 implements ClassFileTransformer {
    private final Map<ExpressionWrapper, PointcutBody> expressionPointcutBodyMap;
    private final Set<String> classNamesSet;
    public Transformer1(Map<ExpressionWrapper, PointcutBody> expressionPointcutBodyMap, String[] classNames) {
